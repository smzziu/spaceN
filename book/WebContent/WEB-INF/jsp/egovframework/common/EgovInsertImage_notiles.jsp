...
function __dlg_init(bottom) {
	...
	if (!document.all) {
		...
		window.resizeTo(body.offsetWidth + 50, body_height + 90);
...
<table border="0" width="400" style="padding: 0px; margin: 0px">
  <tbody>
  <tr>
  ...
  <tr>
    ...
    <td width="350"><input type="text" name="url" id="f_url" style="width:75%"
