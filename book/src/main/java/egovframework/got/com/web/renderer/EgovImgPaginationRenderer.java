 ...
 */
package egovframework.got.com.web.renderer;
...
public class EgovImgPaginationRenderer extends AbstractPaginationRenderer {
    ...
    */
	public EgovImgPaginationRenderer() {
		...
		firstPageLabel = "<a href=\"#\" onclick=\"{0}({1}); return false;\">" +
						"<img src='/images/search/tab_btn_prev.gif' /></a>&#160;";
		previousPageLabel = "<a href=\"#\" onclick=\"{0}({1}); return false;\">" +				
							"<img src='/images/search/tab_btn_prev1.gif' />&#160;&#160;";
		currentPageLabel = "<img src='/images/search/tap_btn_cut.gif'  />{0}<img src='/images/search/tap_btn_cut.gif' />&#160;";
		otherPageLabel = "<a href=\"#\" onclick=\"{0}({1}); return false;\">{2}</a>&#160;";
		
		nextPageLabel = "<a href=\"#\" onclick=\"{0}({1}); return false;\">" +
						"<img src='/images/search/tab_btn_next1.gif' /></a>&#160;";
		lastPageLabel = "<a href=\"#\" onclick=\"{0}({1}); return false;\">" +
						"<img src='/images/search/tab_btn_next.gif' /></a>&#160;";
        /*&nbsp;1&nbsp;<img src="/images/search/tap_btn_cut.gif"  alt=""/>&nbsp;2&nbsp;<img src="/images/search/tap_btn_cut.gif" a alt=""/>
        3&nbsp;<img src="/images/search/tap_btn_cut.gif"  alt=""/>&nbsp;4&nbsp;<img src="/images/search/tap_btn_cut.gif" alt=""/>
        5&nbsp;&nbsp;<img src="/images/search/tab_btn_next1.gif"  alt=""/>&nbsp;<img src="/images/search/tab_btn_next.gif" alt=""/>*/ 
		
        /*String strWebDir = "/images/search/";
